...
function downloadPlanWord() {
    ...
    // Build clean, Word-friendly HTML document. Use octet-stream + appendChild trick to maximize chance of direct download to Downloads folder (bypasses "ask location" and app association prompts in most cases; final behavior also depends on user's browser download settings).
...
window.applyPlanPreset = function(preset) {
  ...
  // Trigger live insight update + highlights + tactics
  setTimeout(() => {
