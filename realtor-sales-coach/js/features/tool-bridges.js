...
(function () {
  ...
  const NURTURE_SCRIPT_BRIDGES = {
    'a-plus-vips': {
      ...
      contextPrefix: 'A+ VIP — top clients and connectors who drive disproportionate business.'
    },
    'past-clients': {
      categoryKey: 'relationship-nurturing',
    ...
    'sphere-of-influence': {
      ...
      contextPrefix: 'Sphere of influence — warm network nurturing.'
    },
    'referral-partners': {
      categoryKey: 'co-broke-conversations',
      scenarioValue: 'Ask a fellow agent for a 1:1 meeting / coffee',
      contextPrefix: 'Agent partners — co-broke and referral relationships.'
    },
    'community-connections': {
      categoryKey: 'relationship-nurturing',
      scenarioValue: 'Offer value to another agent (no ask)',
      contextPrefix: 'Community connections — local presence and genuine value.'
    },
    'prospects': {
      categoryKey: 'most-common',
      scenarioValue: "I'm just shopping around / getting information",
      contextPrefix: 'Database prospects — had interest but not yet under contract.'
    }
  };
...
OPTIONAL 2026 PLAN ALIGNMENT (real estate agent opted in — use only as directional emphasis):
...
Important: Do NOT recycle plan wording verbatim. Generate fresh, specific daily tasks. Alignment should shape emphasis and priorities, not duplicate sentences from the annual plan.`;
  ...
  function sendIdeaToSocial(idea, sourceLabel) {
    ...
    const customIdea = `Behind the scenes of my week as a real estate agent — ${seed}`;
