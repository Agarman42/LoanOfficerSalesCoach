...
function calculateAdvanced() {
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="p-8 bg-white dark:bg-gray-800 rounded-3xl shadow-xl border-2 border-[#00A89D]">
            <div class="flex items-center gap-3 mb-6">
                <i class="fas fa-rocket text-2xl text-[#00A89D]"></i>
                <h4 class="text-2xl font-bold text-[#00A89D]">Your Accelerated Plan</h4>
            </div>
            <div class="space-y-4 text-[15px]">
                ...
                <div class="pt-6 border-t border-gray-200 dark:border-gray-700 flex justify-between items-baseline">
                    ...
                    <span class="text-3xl font-extrabold text-[#00A89D]">$${customInterest.toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 0})}</span>
                </div>
                <div class="pt-4">
