/**
 * Mindset Lab – Interactive toolkit for realtor mindset
...
(function () {
  ...
  // Expanded high-value, realtor-specific content (Big expansion v2 — includes best of classic sales quotes + many new realtor-specific items)
  let mindsetItems = [
    ...
    { id: "res-3", category: "Resilience & Rejection", content: "The realtor who wins is usually the one who simply refuses to quit after the 7th follow-up.", source: "Industry Pattern", action: "Pick your toughest current listing or buyer and commit to one more high-value touch today." },
    ...
    { id: "conf-4", category: "Self-Belief & Confidence", content: "You are not 'just a realtor.' You are the person who helps families achieve one of the biggest life decisions of their lives.", source: "Mindset Lab Original", action: "On your next consultation or showing, say out loud (to yourself or the client): 'My job is to make this feel safe and successful for you.'" },
    ...
    { id: "growth-2", category: "Growth & Long-term Thinking", content: "The realtor who is still doing everything the same way in three years is choosing to be replaced.", source: "Mindset Lab Original", action: "Pick one skill or tool (AI, video, niche content, new partner channel) and spend 3 focused hours on it this week." },
