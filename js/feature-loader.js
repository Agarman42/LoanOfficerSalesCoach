...
(function () {
  ...
  var CORE_SCRIPTS = [
    ...
    'js/app-version.js?v=20260918-v3171',
    ...
    'js/features/pwa-push.js?v=20260912-v3167'
  ];
  ...
  var LAZY_BUNDLES = {
    'newsletter-generator': [
      ...
      'js/features/newsletter-generator.js?v=20260918-nl-layout-v3171',
      'js/features/newsletter-setup-form.js?v=20260720-last-issue-chip',
      'js/features/newsletter-wizard.js?v=20260918-nl-layout-v3171'
    ],
    'smart-savings': [
    ...
    'weekly-win-plan': [
      ...
      'js/features/weekly-win-plan.js?v=20260912-profile-prefill-v3168',
