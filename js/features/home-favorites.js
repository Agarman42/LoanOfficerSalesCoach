...
(function () {
  ...
  const LO_CATALOG = [
    ...
    { sectionId: 'my-pitch', title: 'My Pitch', icon: 'fa-microphone-alt', sub: 'Your story · audio', accent: '#F15A29' },
    { sectionId: 'sales-script', title: 'Sales Scripts', icon: 'fa-comment-dots', sub: 'Live conversations', accent: '#F15A29' },
    { sectionId: 'letter-of-explanation', title: 'Letter of Explanation', icon: 'fa-file-signature', sub: 'Underwriting LOX', accent: '#00A89D' },
    ...
    { sectionId: 'invite-realtors', title: 'Invite realtor partner', icon: 'fa-user-plus', sub: 'Agent Sales Coach', accent: '#00A89D' },
