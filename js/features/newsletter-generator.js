    ...
    try {
        ...
        if (feedback) {
            ...
            promptLines = [
                ...
                '',
                'OUTPUT ONLY complete standalone HTML following this skeleton exactly. You MUST replace the "MAIN CONTENT SECTIONS GO HERE" comment with 4 or more actual full teal card sections (e.g. Market Update, Industry Insights, Local Flavor, Client Win or similar) generated according to the CRITICAL RULES above. Each section must be a complete <tr><td><table width="100%" ... border-left:8px solid #00A89D ... padding:30px> with real content, sources where required, etc. Do not output the comment or the "Example" rows literally — generate real ones. Keep the exact placeholders and the personal note / referral / footer structure as shown.',
                '',
'<!DOCTYPE html>',
    '<html lang="en">',
    ...
    '    <!-- MAIN CONTENT SECTIONS GO HERE (generate 4+ real teal cards here: Market, Industry, Local, etc.) -->',
    '    <tr><td height="20"></td></tr>',
