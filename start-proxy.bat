...
:: ================================================
::  Loan Officer Coach - Grok API Proxy (One-Click Launcher)
:: ================================================

echo.
echo ================================================
echo   Loan Officer Coach - Grok API Proxy
echo ================================================
echo.
...
echo 2. Recommended: open http://localhost:3000 in browser.
echo    (Or use your own server e.g. on 8080 for the HTML; API calls will still hit the proxy on 3000.)
echo 3. When you use any AI feature (Weekly Win Plan, scripts, etc.),
